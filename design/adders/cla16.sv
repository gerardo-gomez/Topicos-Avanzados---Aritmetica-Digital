...
module cla16 (
  ...
  assign ov_f   = is_signed
                ? ((srca[15] ^ result[15]) & (srcb[15] ^ result[15])) // Overflow para signed:   si el signo del resultado es diferente al de ambos operandos
