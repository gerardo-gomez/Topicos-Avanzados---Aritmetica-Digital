// Description: This file contains exactly the same adder modules as in cla.sv and rca.sv
//              The purpose is being able to instantiate both in the same project without
//              renaming the modules since both modules are named "adder" to be compliant
//              with the interface in the adder assignment.
