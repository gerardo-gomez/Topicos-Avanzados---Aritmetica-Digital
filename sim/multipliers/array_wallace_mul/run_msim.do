# To run sim:
# $ cd <repo_root>
# $ vsim    -do ./sim/multipliers/array_wallace_mul/run_msim.do # To open Questa GUI and view waveforms.
# $ vsim -c -do ./sim/multipliers/array_wallace_mul/run_msim.do # To execute Questa CLI (-c) and check test status.
...
vlog -sv -work work -suppress 13314 {./design/multipliers/array_wallace_mul.sv}
...
#view structure
#view signals
#do ./sim/multipliers/array_wallace_mul/wave.do
