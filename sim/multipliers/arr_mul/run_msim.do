# To run sim:
# $ cd <repo_root>
# $ vsim    -do ./sim/multipliers/arr_mul/run_msim.do # To open Questa GUI and view waveforms.
# $ vsim -c -do ./sim/multipliers/arr_mul/run_msim.do # To execute Questa CLI (-c) and check test status.
...
# Design files
vlog -sv -work work -suppress 13314 {./design/multipliers/arr_mul.sv}
...
#view structure
#view signals
#do ./sim/multipliers/arr_mul/wave.do
