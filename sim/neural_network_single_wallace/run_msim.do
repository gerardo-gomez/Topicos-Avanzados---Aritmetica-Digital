# To run sim:
# $ cd <repo_root>
# $ vsim    -do ./sim/neural_network_single_wallace/run_msim.do # To open Questa GUI and view waveforms.
# $ vsim -c -do ./sim/neural_network_single_wallace/run_msim.do # To execute Questa CLI (-c) and check test status.
...
vlog -sv -work work -suppress 13314 {./design/multipliers/booth4_pp.sv}
vlog -sv -work work -suppress 13314 {./design/fma/fma_dp_single_wallace.sv}
...
#view structure
#view signals
#do ./sim/neural_network_single_wallace/wave.do
