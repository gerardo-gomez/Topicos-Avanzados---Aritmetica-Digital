# To run sim:
# $ cd <repo_root>
# $ vsim    -do ./sim/fma/fma/run_msim.do # To open Questa GUI and view waveforms.
# $ vsim -c -do ./sim/fma/fma/run_msim.do # To execute Questa CLI (-c) and check test status.
...
vlog -sv -work work -suppress 13314 {./design/fma/fma.sv}
