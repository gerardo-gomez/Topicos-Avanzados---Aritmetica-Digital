...
add wave -noupdate /tb_csa/operands
...
add wave -noupdate /tb_csa/dut/wallace_tree/tree_in
add wave -noupdate /tb_csa/dut/wallace_tree/tree_out
...
update
WaveRestoreZoom {9999375 ps} {10000033 ps}
