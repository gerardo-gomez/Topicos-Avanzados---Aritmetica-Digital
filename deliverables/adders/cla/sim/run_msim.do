...
# Design files
vlog -sv -work work -suppress 13314 {../../../rtl/adders/lcu4.sv}
vlog -sv -work work -suppress 13314 {../../../rtl/adders/cla4.sv}
vlog -sv -work work -suppress 13314 {../../../rtl/adders/cla.sv}

# Testbench files
vlog -sv -work work -suppress 13314 {./sim/tb_adder.sv}
