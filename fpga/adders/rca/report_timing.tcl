...
# $ quartus_sh.exe --flow compile ./fpga/adders/rca/fpga_top.qpf
#
# To run this script:
# $ cd <repo_root>
# $ quartus_sta.exe -t fpga/adders/rca/report_timing.tcl
#
# Note: Ensure that < Intel® Quartus® Prime directory>/quartus/bin directory is in your PATH environment variable
#
# Open project
project_open -force "./fpga/adders/rca/fpga_top.qpf" -revision "fpga_top"
# Netlist Setup
